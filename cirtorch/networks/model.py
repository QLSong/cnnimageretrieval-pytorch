...
class RetrievalNet(nn.Module):
    def __init__(self):
        ...
        self.pooling = GeM()
        self.upsample0 = nn.Conv2d(256, 2048, 1)
        self.upsample1 = nn.Conv2d(512, 2048, 1)
        self.upsample2 = nn.Conv2d(1024, 2048, 1)
    ...
    def forward(self, x):
        ...
        #c0 = self.upsample0(f0)+f1
        #c1 = self.upsample1(c0)+f2
        #c2 = self.upsample2(c1)+f3

        y = self.upsample0(f0)+self.upsample1(f1)+self.upsample2(f2)+f3
